import 'package:peak_card_game/models/draw_model.dart';
import 'package:peak_card_game/models/deck_model.dart';
import 'package:peak_card_game/services/api_service.dart';
...
class DeckService extends ApiService {
  ...
  Future<DrawModel> drawDeck(DeckModel deck, {int count = 1}) async {
    final data = await httpGet(
